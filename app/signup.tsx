...
import {
  ...
  TouchableOpacity, SafeAreaView, StatusBar, Platform, KeyboardAvoidingView,
} from 'react-native';
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <KeyboardAvoidingView style={styles.kav} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <View style={styles.container}>
          ...
          <Text style={styles.sub}>Start your language journey today.</Text>
...
const styles = StyleSheet.create({
  ...
  logoMark: {
    ...
    backgroundColor: '#6D28D9', justifyContent: 'center', alignItems: 'center', marginRight: 10,
  },
  logoText: { color: '#fff', fontSize: 14, fontWeight: '800', letterSpacing: 0.5 },
  logoName: { color: '#fff', fontSize: 20, fontWeight: '700', letterSpacing: -0.5 },
  heading: { fontSize: 34, fontWeight: '800', color: '#FFFFFF', letterSpacing: -1, marginBottom: 8 },
  sub: { fontSize: 16, color: '#4B5563', marginBottom: 40 },
  ...
  input: { flex: 1, paddingVertical: 16, fontSize: 16, color: '#F1F5F9' },
  eyeBtn: { padding: 4 },
  primaryBtn: {
    flexDirection: 'row',
    backgroundColor: '#6D28D9', paddingVertical: 17, borderRadius: 14,
    alignItems: 'center', justifyContent: 'center', marginBottom: 20,
    ...Platform.select({
      ios: { shadowColor: '#6D28D9', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.45, shadowRadius: 12 },
      android: { elevation: 8 },
    }),
  },
  primaryBtnText: { color: '#FFFFFF', fontWeight: '700', fontSize: 16, letterSpacing: -0.2 },
